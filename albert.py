# -*- coding: utf-8 -*-
"""Copy of chinese_text_binary_classification_with_bert.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1hMKIyDTDDLybhjRsPiOK_WUkE3oIlUdq
...
def make_features(
    dataset, label_list, MAX_SEQ_LENGTH, tokenizer, DATA_COLUMN, LABEL_COLUMN
):
    input_example = dataset.apply(
...
def model_fn_builder(
    bert_model_hub, num_labels, learning_rate, num_train_steps, num_warmup_steps
):
...
def run_on_dfs(
    ...
    train_features = make_features(
        train, label_list, MAX_SEQ_LENGTH, tokenizer, DATA_COLUMN, LABEL_COLUMN
    )
    test_features = make_features(
        test, label_list, MAX_SEQ_LENGTH, tokenizer, DATA_COLUMN, LABEL_COLUMN
    )
...
with open(
    "/Users/kevin/Workspace/food_safety/data/safety_train_valid.pickle", "rb"
) as f:
...
myparam = {
    ...
    "LABEL_COLUMN": "label",
    "BATCH_SIZE": 128,
    "LEARNING_RATE": 6e-5,  # 6e-5 1e-4 2e-5
    "NUM_TRAIN_EPOCHS": 5,
    "bert_model_hub": "https://tfhub.dev/google/bert_chinese_L-12_H-768_A-12/1",
}
...
def getPrediction(in_sentences, estimator):
    ...
    tokenizer = create_tokenizer_from_hub_module(bert_model_hub)
    input_examples = [
        bert.run_classifier.InputExample(guid=None, text_a=x, text_b=None, label=0)
